...
struct void print_advertising_devices(int dd, uint8_t filter_type, struct message *messages) {
...
struct void scan(struct message *messages) {
//-----------------------------------------SCAN---------------------------
